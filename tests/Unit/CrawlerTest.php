...
HTML;
    ...
    {
        $this->assertTrue($this->crawler instanceof CrawlerInterface);
    }
    ...
    {
        $this->assertTrue(Crawler::create() instanceof CrawlerInterface);
    }
    ...
    public function testSetMaxCrawl()
    {
        ...
        $this->assertTrue($returnedCrawler instanceof CrawlerInterface);
    ...
    /**
     * Test for startCrawling() method with a db repository
     *
     * @return void
     */
    public function testStartCrawlingDBRepository()
    {
        $repository = new CrawledDBRepository();
        $url = new Uri('http://example.com/');
        Crawler::create()
            ->setMaxCrawl(5)
            ->setRepository($repository)
     ...
     * @return void
     */
    public function testStartCrawlingAlreadyInDBRepository()
    {
        $repository = new CrawledMemoryRepository();
        $url = 'http://example.com/';
        $page = new WebPage();
